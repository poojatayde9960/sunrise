    ...
    return (
        <section className="w-full bg-white py-20">
            <div className="max-w-7xl mx-auto px-6">
                ...
                {/* CTA BOX */}
                <div className="relative overflow-hidden rounded-lg bg-[#111] py-20 px-6 text-center text-white">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto">
                        ...
                        <p className="mt-4 text-gray-300 text-sm md:text-base">
                            Upgrade your home with powerful, energy-efficient heating
                            solutions designed for everyday comfort.
                        </p>
