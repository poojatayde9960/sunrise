...
const LoginPage = () => {
    return (
        <div className="min-h-screen flex items-center mt-9 justify-center bg-white px-6">
            ...
            <div className="w-full max-w-6xl bg-white rounded-3xl shadow-lg p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    ...
                    {/* RIGHT LOGIN CARD */}
                    <div className="border border-gray-200 rounded-xl p-8 max-w-md mx-auto w-full">
